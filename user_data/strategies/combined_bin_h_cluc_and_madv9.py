...
# taken from: https://github.com/akivacz/freqtrade/blob/develop/user_data/strategies/CombinedBinHClucAndMADV9.py
...
class CombinedBinHClucAndMADV9(IStrategy):
        ...
        if current_profit > 0:
            ...
            if trade_time_60 > trade.open_date_utc:
                number_of_candle_shift = int(
                    (trade_time_60 - trade.open_date_utc).total_seconds() / 300
                )
    ...
    def informative_1h_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        if not self.dp:
            print("DataProvider is required for multiple timeframes.")
